...
public class EditBook extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("SEN BOOKSTORE EDIT BOOK INFO");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Book ID", "Book Name ", "Book Author ", "Selling Price (RM)", "Genre", "Description", "Select"
            }
        ) {
    ...
    DefaultTableModel tbModel2 = (DefaultTableModel)ce.jTable1.getModel();
    ...
    private void searchBoxActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchBoxActionPerformed
        ...
        if(s.isEmpty())
        {
            sql= "select bookId, bookName, bookAuthor, sPrice, genre, descript from bookInfo ";
        }
        else
        {

            sql="select bookId, bookName, bookAuthor, sPrice, genre, descript from bookInfo where bookId like '%"+s+"%' or bookName like '%"+s+"%' or bookAuthor like '%"+s+"%'";
        }
        ...
        try
        {
            ...
            while(book.next())
            {
                ...
                String descript= book.getString("descript");//convery to string
                

                String tbData[] ={bookId,bookName,bookAuthor,sPrice,genre,descript};//for later to  dicplay all the data in the table
